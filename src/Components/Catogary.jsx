            ...
            <div className="main">
                ...
                <div className="doubleCard">
                    ...
                    <div className="construction0">
                        ...
                        <div className="right">
                            ...
                            <div className="uright1">
                                <button type='submit' className='numbtn'> <span class="material-symbols-outlined">
                                    call
                                </span> <span className='numm'> +91 08123458928</span></button>
                    ...
                    <div className="construction">
                        ...
                        <div className="cont1">
                            <span className='upper'>Construction</span>
                            <img className='img1' src='https://media.istockphoto.com/id/488120139/photo/modern-real-estate.jpg?s=1024x1024&w=is&k=20&c=UrKkZnZYm4O146XzgU6HAuvSK8RxCyJWkznmhZSEKPQ=' />
                        </div>
                ...
                <div className="doubleCard">
                    ...
                    <div className="construction">
                        <div className="cont1">
                            <span className='upper'>Construction</span>
                            <img className='img1' src='https://media.istockphoto.com/id/1351571961/photo/looking-directly-up-at-the-skyline-of-the-financial-district-in-central-london.jpg?s=1024x1024&w=is&k=20&c=w66hXE0hFdhDestn9AFOaTSR9tUbNLQeCdW8a8fXMDU=' />
                        </div>
                        ...
                        <div className="right">
                            ...
                            <div className="uright1">
                                <button type='submit' className='numbtn'> <span class="material-symbols-outlined">
                                    call
                                </span> <span className='numm'> +91 8860009003</span></button>
                                <button type='submit' className='numbtn0'>Send Enquiry</button>
                            </div>
                    ...
                    <div className="construction">
                        ...
                        <div className="cont1">
                            <span className='upper'>Construction</span>
                            <img className='img1' src='https://media.istockphoto.com/id/1165384568/photo/europe-modern-complex-of-residential-buildings.jpg?s=1024x1024&w=is&k=20&c=1golptGIidGvd8qhQ7FvKAT2lFl7hIu8KGCJzBT_H8o=' />
                        </div>
                        ...
                        <div className="right">
                            ...
                            <div className="uright1">
                                <button type='submit' className='numbtn'> <span class="material-symbols-outlined">
                                    call
                                </span> <span className='numm'> +91 8123458928</span></button>
                                <button type='submit' className='numbtn0'>Send Enquiry</button>
                            </div>
